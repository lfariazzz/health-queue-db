...
def menu():
    while True:
        ...
        if opcao == "1":
            ...
            print("1 - SEG  2 - TER  3 - QUA  4 - QUI  5 - SEX  6 - SAB  7 - DOM")
            ...
            try:
                inserir_oferece(int(id_unidade), int(id_servico), dia_semana,
                                hora_inicio, hora_final, int(vagas))
            ...
            print("1 - PENDENTE  2 - CONFIRMADO  3 - CANCELADO  4 - REALIZADO")
            status_opcao = input("Digite o número da opção: ").strip()

            status_map = {
                "1": "PENDENTE", "2": "CONFIRMADO",
                "3": "CANCELADO", "4": "REALIZADO"
            }
